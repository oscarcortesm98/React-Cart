...
const Cart = () => {
  ...
  return (
    <section className={`fixed grid grid-rows-[auto_1fr_auto] h-screen w-[295px] top-0 bg-white text-sm ${isShowCart && token ? "right-2 sm:right-4" : "-right-full"} p-2 transition-all duration-300 shadow-lg shadow-gray-600 sm:w-[310px] h-[97%] top-[1%] rounded-xl`}>
